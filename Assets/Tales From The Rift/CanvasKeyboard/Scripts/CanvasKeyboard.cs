...
namespace TalesFromTheRift
{
	public class CanvasKeyboard : MonoBehaviour 
	{
        ...
        public GameObject wordGameManager;

        public void Start()
        {
            wordGameManager = GameObject.FindGameObjectWithTag("gamelogic");
		...
		public void SendKeyString(string keyString)
		{
          ...
          wordGameManager.GetComponent<WordWheelLogic>().ProcessGuess(keyString);
