...
[RequireComponent(typeof(ForWorldKeyModule))]
public class ForWorldKeyCrosshair : MonoBehaviour 
{
	...
	private ForWorldKeyModule gazeInputModule;
	private Vector3 CrosshairOriginalScale;
	private float CrosshairOriginalDistance;

	void Awake()
	{
		gazeInputModule = GetComponent<ForWorldKeyModule>();
	}
